# iSmart Platform — Многоязычная веб-экосистема

## Обзор проекта

Современное многоязычное веб-приложение, построенное на основе модульной архитектуры с использованием PHP, Twig и JSON. Экосистема ориентирована на производительность, SEO-оптимизацию и удобство управления контентом через JSON-файлы.
...
GEO (Generative Engine Optimization) — оптимизация контента для AI-поисковиков (Google AI Overviews, Bing Chat, Perplexity, ChatGPT Search и др.), чтобы LLM могли находить, понимать и цитировать контент экосистемы.
...
Экосистема построена с учётом лучших практик разработки, производительности и SEO-оптимизации. Модульная архитектура обеспечивает лёгкость поддержки и расширения функциональности.

...
Соглашения по структуре файлов, порядку импортов, именованию селекторов и использованию переменных. Дополняет [html-naming.md](html-naming.md) в части классов и уровней структуры.
...
Соответствует [html-naming.md](html-naming.md): BEM-подобная схема, kebab-case, уровни section/component.
...
- [html-naming.md](html-naming.md) — классы, id, data-атрибуты, контент
- [js-naming.md](js-naming.md) — JavaScript и селекторы js-\*
- [twig-naming.md](twig-naming.md) — шаблоны и данные
- [json-naming.md](json-naming.md) — структура данных страниц и global

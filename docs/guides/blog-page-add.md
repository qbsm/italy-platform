...
```json
{
  ...
  "cover": {
    "src": "data/img/project-name/horizontal/raw/1.webp",
    "alt": "cover"
  },
  "items": [...]
}
...
### Изображения обложек
- Используйте изображения из `data/img/` (подкаталоги по разделу: blog, content и т.д.)
...
```json
{
  ...
  "cover": {
    "src": "data/img/bauhaus/horizontal/raw/1.webp",
    "alt": "cover"
  },
  "items": [
    {
...
```json
{
  ...
  "cover": {
    "src": "data/img/tikhaya-gavan/horizontal/raw/1.webp",
    "alt": "cover"
  }
}
```

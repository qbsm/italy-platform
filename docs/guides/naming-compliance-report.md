# Отчёт о соответствии html-naming.md и css-naming.md

Проверка выполнена по состоянию репозитория. Ниже — нарушения и рекомендации.

---

## 1. Идентификаторы (`id`) — html-naming.md, §3
...
## 2. Хардкод цветов в CSS — css-naming.md, §4 и §5
...
## 3. Класс `.button-icon` в form-callback.css — css-naming.md, §1 и §4
...
- **Структура CSS:** один блок — один файл в `sections/` и `components/`; порядок импортов в main.css соответствует css-naming.md (base → sections → components → pages).
